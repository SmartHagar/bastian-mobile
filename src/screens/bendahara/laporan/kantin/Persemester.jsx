...
const Persemester = () => {
  ...
  //   download file
  const REMOTE_IMAGE_PATH = `${BASE_URL}/export/pdf/semester?semester=${semester}&tahun=${tahun}&kantin=kantin`;
  ...
  const downloadFile = () => {
    ...
    let options = {
      ...
      addAndroidDownloads: {
        ...
        notification: true,
        path:
          FileDir + `/bas-aplikasi/Buku Kas Kantin ${semester}-${tahun}.pdf`,
        description: 'PDF',
      },
    };
    config(options)
